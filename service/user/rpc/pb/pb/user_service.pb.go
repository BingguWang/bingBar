...
var file_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x68, 0x41, 0x66, 0x74, 0x65, 0x72, 0x32, 0xfa, 0x02, 0x0a, 0x0b, 0x55, 0x73,
...
var file_user_service_proto_depIdxs = []int32{
	...
	4,  // 3: pb.UserService.login:input_type -> pb.LoginReq
	2,  // 4: pb.UserService.register:input_type -> pb.RegisterReq
	6,  // 5: pb.UserService.getUserInfo:input_type -> pb.GetUserInfoReq
	8,  // 6: pb.UserService.getUserAuthByAuthKey:input_type -> pb.GetUserAuthByAuthKeyReq
	10, // 7: pb.UserService.getUserAuthByUserId:input_type -> pb.GetUserAuthByUserIdReq
	12, // 8: pb.UserService.generateToken:input_type -> pb.GenerateTokenReq
	5,  // 9: pb.UserService.login:output_type -> pb.LoginResp
	3,  // 10: pb.UserService.register:output_type -> pb.RegisterResp
	7,  // 11: pb.UserService.getUserInfo:output_type -> pb.GetUserInfoResp
	9,  // 12: pb.UserService.getUserAuthByAuthKey:output_type -> pb.GetUserAuthByAuthKeyResp
	11, // 13: pb.UserService.getUserAuthByUserId:output_type -> pb.GetUserAuthyUserIdResp
	13, // 14: pb.UserService.generateToken:output_type -> pb.GenerateTokenResp
